...
import editAccommodationReducer from "./reducers/edit-accommodation";
import editPlanReducer from "./reducers/edit-plan";
...
const store = createStore(
  combineReducers({
    ...
    editAccommodation: editAccommodationReducer,
