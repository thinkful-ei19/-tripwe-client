    ...
    return (
      <div className="ct-budget ct-card">
        ...
        >
          ...
          <Field component={Input} type="text" name="expense1" id="expense1" />
          <Field component={Input} type="text" name="expense2" />
          <Field component={Input} type="text" name="expense3" />
          <button className="ct-budget__add">Add</button>
          <div className="ct-next-skip">
            {/* <button className="ct-budget__skip skip">Skip</button> */}
            <button
              className="ct-budget__next next"
